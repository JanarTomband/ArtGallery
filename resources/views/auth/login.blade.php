                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control" name="email" style="background-color: rgba(0,0,0,.55); border-color: #525e82" value="{{ old('email') }}" required autofocus>
                            ...
                            <div class="col-md-6 col-md-offset-4">
                                <div class="checkbox" >
                                    <label  style="color:#6f7996">
                                        <input type="checkbox" name="remember" style="background-color: rgba(0,0,0,.55);" {{ old('remember') ? 'checked' : '' }}> Remember Me
                                    </label>
                                </div>
                            </div>
                        </div>
